(function () {
    let navbarToggler = document.getElementsByClassName(
        "ct-docs-navbar-toggler"
    )[0];
    navbarToggler.addEventListener("click", function () {
        let sidebarCollapseLinks = document.getElementsByClassName(
        ...
        if (sidebarCollapseLinks.style.maxHeight) {
            ...
            sidebarCollapseLinks.style.maxHeight =
                sidebarCollapseLinks.scrollHeight + 48 + "px";
    ...
    function dropdownEvent(event) {
        ...
        let dropdownMenu = currentEventTarget.getElementsByClassName(
            "ct-docs-navbar-dropdown-menu"
        )[0];
        if (
            dropdownMenu.classList.contains("ct-docs-navbar-dropdown-menu-show")
        ) {
